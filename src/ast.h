...
struct ASTNode {
    ...
    union {
        ...
        struct { char *name; char *op; ASTNode *value; } compound_assign;
        struct { char *name; char *op; int is_prefix; } incdec;
        struct { char *name; ASTNode *value; } var_decl;
        struct { char *name; ASTNode *value; } let_decl;
        ...
        struct { ASTNode *object; ASTNode *index; ASTNode *value; } index_assign;
